...
describe("Foreign Keys", () => {
  ...
  it(
    ...
    async done => {
      const genreId = 5;
      const query = `DELETE FROM ${GENRES} WHERE ${GENRES}.id = ${genreId}`;
      try {
  ...
  it(
    ...
    async done => {
      const directorId = 7;
      const query = `DELETE FROM ${DIRECTORS} WHERE ${DIRECTORS}.id = ${directorId}`;
      try {
        await db.delete(query);
      } catch (e) {}
  ...
  it(
    ...
    async done => {
      const actorId = 10;
      const query = `DELETE FROM ${ACTORS} WHERE ${ACTORS}.id = ${actorId}`;
      try {
        await db.delete(query);
      } catch (e) {}
  ...
  it(
    ...
    async done => {
      const keywordId = 12;
      const query = `DELETE FROM ${KEYWORDS} WHERE ${KEYWORDS}.id = ${keywordId}`;
      try {
        await db.delete(query);
      } catch (e) {}
  ...
  it(
    ...
    async done => {
      const companyId = 12;
      const query = `DELETE FROM ${PRODUCTION_COMPANIES} WHERE ${PRODUCTION_COMPANIES}.id = ${companyId}`;
      try {
        await db.delete(query);
      } catch (e) {}
  ...
  it(
    ...
    async done => {
      const movieId = 100;
      const query = `DELETE FROM ${MOVIES} WHERE ${MOVIES}.id = ${movieId}`;
      try {
        await db.delete(query);
      } catch (e) {}
  ...
  it(
    ...
    async done => {
      const movieId = 5915;
      const query = 
      `DELETE FROM ${MOVIES} WHERE ${MOVIES}.id = ${movieId}`;
